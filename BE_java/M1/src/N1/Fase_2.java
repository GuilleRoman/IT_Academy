...
public class Fase_2 {
	...
	public static void main(String[] args) {
		int quantsTraspas=0;		//Contador dels anys de traspàs.
		...
		System.out.println("Anys de traspàs de l'any "+anyInicial+ " fins "+anyFinal);
		
		//Determinem els anys de traspàs els comptem i els mostrem
		...
		//Mostrem total
		System.out.println("\nEl nombre d'anys de traspàs entre "+anyInicial+" i el "+anyFinal+" son :"+quantsTraspas);

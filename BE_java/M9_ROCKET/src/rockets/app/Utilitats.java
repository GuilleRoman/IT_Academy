...
public final class Utilitats {
	 ...
	 * esSencerPositiu
	 * 
	 * Determina si l'string passat com a paràmetre, és un nombre sencer positiu.
	 * Inclou el zero com a entrada correcta.
	 * 
	 * @param 	cadena	String
	 * @return	sencerPositiu	boolean 	true , false
	 */
	public static int esSencerPositiu(String cadena) {
		int sencerPositiu = -1;
		...
		try {
            ...
            if (Integer.parseInt(cadena)>=0){
 		      sencerPositiu = Integer.parseInt(cadena); 		      
 		     }
